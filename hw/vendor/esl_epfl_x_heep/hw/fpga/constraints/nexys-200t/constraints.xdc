...
### DRC overrides — allow unconnected peripheral ports to be auto-placed
# Ports like gpio_io, spi_*, i2c_*, i2s_*, pdm2pcm_* are not wired to board
# pins on this minimal build. Vivado requires all ports to have LOC and
# IOSTANDARD; demoting to warnings lets bitstream generation proceed.
