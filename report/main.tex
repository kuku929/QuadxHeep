...
build environment~\cite{quadxheep_repo}.
\end{abstract}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\columnwidth]{../plot_conv.png}
  \caption{Cycle counts for convolution (im2col) on Quadrilatero vs.\
           scalar X-HEEP for two small input configurations.}
...
verified simulation. The full build environment and patched sources are available
at~\cite{quadxheep_repo}.
